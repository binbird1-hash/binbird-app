...
export function NotificationPreferencesForm() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    const { error } = await supabase.from('notification_preferences').upsert({
      ...
      user_id: user.id,
      email_route_updates: formState.emailRouteUpdates,
      push_route_updates: formState.pushRouteUpdates,
      email_billing: formState.emailBilling,
      push_billing: formState.pushBilling,
      email_property_alerts: formState.emailPropertyAlerts,
      push_property_alerts: formState.pushPropertyAlerts,
    })
