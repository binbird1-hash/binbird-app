...
function PortalScaffold({ children }: { children: ReactNode }) {
  ...
  if (error) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#12131a] px-4 [background-image:radial-gradient(circle_at_top,_#1f2029,_#12131a)]">
  ...
  return (
    <div className="relative min-h-screen bg-[#12131a] px-4 py-10 text-white [background-image:radial-gradient(circle_at_top,_#1f2029,_#12131a)]">
